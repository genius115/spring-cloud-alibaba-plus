...
{
    baseURL: 'http://localhost:15301/magic/web', //必填
        serverURL
:
    'http://localhost:15301/',    // 必填
        title
:
    'magic-api',
        defaultTheme
...
,
    themes: {
        ...
        ,
            ...
            :
                '#bbb',
                    'toolbox-list-span-color'
            :
                '#787878',
                    'toolbox-border-color'
            :
                '#323232',
                    'toolbox-list-hover-background'
            :
                '#0D293E',
                    'toolbox-border-right-color'
            :
                '#555555',
                    'footer-border-color'
            :
            ...
            :
                '#151515',
                    'dialog-button-hover-background'
            :
                '#365880',
                    'dialog-button-hover-border-color'
            :
                '#43688C',
